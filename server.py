...
class WatchplantMain(dbus.service.Object):
    def __init__(self):
    ...
    def GetManagedObjects(self):
        ...
        for service in self.services:
            ...
            for characteristic in characteristics:
                ...
                descscriptors = characteristic.get_descriptors()
                for descscriptor in descscriptors:
                    response[descscriptor.get_path()] = descscriptor.get_properties()
    ...
    def register_app_error_callback(self, error):
        print("Failed to initilize server: " + str(error))
...
class Descriptor(dbus.service.Object):
    ...
    def get_properties(self):
        return {
                GATT_DESC_IFACE: {'Characteristic': self.chrc.get_path(), 'UUID': self.uuid, 'Flags': self.flags,
                }
        }
